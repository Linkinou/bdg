 ...
 */
final class Version20190305055427 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game ADD story LONGTEXT NOT NULL, ADD slug VARCHAR(128) NOT NULL, ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, DROP goal, CHANGE description description LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game ADD goal LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, DROP story, DROP slug, DROP created_at, DROP updated_at, CHANGE description description LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
